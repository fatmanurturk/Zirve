...
function ResetPasswordContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(axiosError.response?.data?.detail || "Şifre güncellenemedi. Token süresi dolmuş olabilir.");
    } finally {
      setIsLoading(false);
    }
  };
...
export default function ResetPasswordPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">Yükleniyor...</div>}>
